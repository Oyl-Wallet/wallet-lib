...
const addAnyInput = async ({ psbt, utxo, provider, account, }) => {
...
exports.addAnyInput = addAnyInput;
const addSingleAddressInput = async ({ psbt, utxo, provider, account, }) => {
    if (getAddressType(utxo.address) === 0) {
        const previousTxHex = await provider.esplora.getTxHex(utxo.txId);
        psbt.addInput({
            hash: utxo.txId,
...
exports.addSingleAddressInput = addSingleAddressInput;
