...
const addBtcUtxo = async ({ spendUtxos, toAddress, psbt, amount, feeRate, network, spendAddress, spendPubKey, altSpendAddress, altSpendPubKey, altSpendUtxos, }) => {
    ...
    const altSpendAddressType = (0, transactions_1.getAddressType)(altSpendAddress);
    const spendAddressType = (0, transactions_1.getAddressType)(spendAddress);
    let redeemScript = null;
    if (exports.addressTypeMap[altSpendAddressType] === 'p2sh' && usingAlt === true) {
    ...
    if (exports.addressTypeMap[spendAddressType] === 'p2sh') {
