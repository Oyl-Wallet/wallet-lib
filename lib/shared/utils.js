...
exports.nativeSegwitFormat = nativeSegwitFormat;
...
exports.nestedSegwitFormat = nestedSegwitFormat;
...
exports.taprootFormat = taprootFormat;
...
function getOutputFormat(script, network) {
    const p2sh = (0, exports.nestedSegwitFormat)(script, network);
    if (p2sh.data) {
        return interface_1.AddressType.P2SH_P2WPKH;
    }
    const p2wpkh = (0, exports.nativeSegwitFormat)(script, network);
    if (p2wpkh.data) {
        return interface_1.AddressType.P2WPKH;
    }
    const p2tr = (0, exports.taprootFormat)(script, network);
    if (p2tr.data) {
...
exports.getTxSizeByAddressType = getTxSizeByAddressType;
