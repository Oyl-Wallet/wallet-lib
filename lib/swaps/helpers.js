...
exports.buildPsbtWithFee = exports.estimatePsbtFee = exports.psbtTxAddressTypes = exports.sanitizeFeeRate = exports.calculateAmountGathered = exports.canAddressAffordBid = exports.getBidCostEstimate = exports.addInputConditionally = exports.getAllUTXOsWorthASpecificValue = exports.isExcludedUtxo = exports.getUTXOsToCoverAmount = exports.DUMMY_UTXO_SATS = exports.ESTIMATE_TX_SIZE = exports.CONFIRMED_UTXO_ENFORCED_MARKETPLACES = exports.maxTxSizeForOffers = void 0;
...
async function buildPsbtWithFee({ inputTemplate = [], outputTemplate = [], changeOutput, retrievedUtxos = [], spendAddress, spendPubKey, amountRetrieved, spendAmount, addressType, feeRate, provider }) {
