...
async function buildPsbtWithFee({ inputTemplate = [], outputTemplate = [], retrievedUtxos = [], amountNeeded, spendAddress, spendPubKey, amountRetrieved, spendAmount, addressType, provider, network }) {
