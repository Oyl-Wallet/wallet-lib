...
const alkaneCommand = new commander_1.Command('alkanes')
    .description('Functions for alkanes')
    .addCommand(alkanes_1.alkaneContractDeploy)
    .addCommand(alkanes_1.alkaneExecute)
    .addCommand(alkanes_1.alkaneTokenDeploy)
    .addCommand(alkanes_1.alkanesTrace)
    .addCommand(alkanes_1.alkaneSend);
