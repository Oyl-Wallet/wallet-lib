...
const config = {
    ...
    [TESTNET]: {
        ...
        wallet: testWallet,
        nestedSegwitPrivateKey: process.env.NESTED_SEGWIT_PRIVATEKEY,
        segwitPrivateKey: process.env.TESTNET_SEGWIT_PRIVATEKEY,
...
async function runCLI() {
    ...
    const signer = new signer_1.Signer(bitcoin.networks.testnet, {
        ...
        nestedSegwitPrivateKey: networkConfig.nestedSegwitPrivateKey,
    });
    switch (command) {
        case 'load':
        ...
        case 'send':
            const res = await networkConfig.wallet.sendBtc({
                fromAddress: '2NGEK3aPwZuvPaZSjYjwRox7aM8Lre6vMcn',
                toAddress: networkConfig.taprootAddress,
                feeRate: 20,
                amount: 50,
                spendAddress: '2NGEK3aPwZuvPaZSjYjwRox7aM8Lre6vMcn',
                spendPubKey: '0378eb788e83afcaf77d9fce0da001ff72a4553bdcc988c2a84b31349d5f528e51',
